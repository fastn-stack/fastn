          ...
          if (!ssr) {
            ...
            if (fastn_utils.isNull(value)) {
              ...
              if (!fastn_dom.classes[cssClass]) {
                ...
                styles.innerHTML = `${styles.innerHTML}${getClassAsString(
                  cssClass,
                  obj,
                )}\n`;
              }
    ...
    if (kind === fastn_dom.PropertyKind.Children) {
      ...
      switch (backdropType) {
        ...
        case 2:
          this.attachCss(
            "backdrop-filter",
            `brightness(${fastn_utils.getStaticValue(staticValue[1])})`,
          );
          break;
        case 3:
          this.attachCss(
            "backdrop-filter",
            `contrast(${fastn_utils.getStaticValue(staticValue[1])})`,
          );
          break;
        case 4:
          this.attachCss(
            "backdrop-filter",
            `greyscale(${fastn_utils.getStaticValue(staticValue[1])})`,
          );
          break;
        case 5:
          this.attachCss(
        ...
        case 6:
          this.attachCss(
            "backdrop-filter",
            `opacity(${fastn_utils.getStaticValue(staticValue[1])})`,
          );
          break;
        case 7:
          this.attachCss(
        ...
        case 8:
          this.attachCss(
            "backdrop-filter",
            `saturate(${fastn_utils.getStaticValue(staticValue[1])})`,
          );
          break;
        case 9:
      ...
      kind === fastn_dom.PropertyKind.DocumentProperties.MetaTwitterDescription
    ) {
