...
body-local = The { $target-lang } document was last translated from the { $primary-lang } version on { $last-merged-on }. Since then, the { $primary-lang } version has the following changes.
