...
window.ftd.post_init = function () {
    ...
    window["ls.set_boolean"] = function(_id, resolved_data, reference) {
        ...
        if (!window.localStorage && !window.ftd_warnings_delivered["ls.set_boolean"]) {
    ...
    function scan_local_store() {
        ...
        Object.keys(window.localStorage).forEach(function(key){
            // TODO: how do we handle id? we are harcoding main here, which is wrong
            window.ftd.set_value("main", key, window.localStorage.getItem(key));
        });
    }
