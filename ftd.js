    ...
    function handle_event(evt, id, action, obj) {
        ...
        if (act === "stop-propagation") {
            ...
            if (action["parameters"].data !== undefined) {
                let data = JSON.parse(action["parameters"].data[0].value)
            ...
            if (action["parameters"].by !== undefined) {
                increment = parseInt(action["parameters"].by[0].value);
            }
            ...
            if (action["parameters"]["clamp"] !== undefined) {
                ...
                if (clamp_value.length === 1) {
                    clamp_max = parseInt(clamp_value[0].value);
                }
                if (clamp_value.length === 2) {
                    clamp_min = parseInt(clamp_value[0].value);
                    clamp_max = parseInt(clamp_value[1].value);
                }
            }
            ...
            let decrement = -1;
            if (action["parameters"].by !== undefined) {
                decrement = -parseInt(action["parameters"].by[0].value);
            }
