...
echo "2. Start servers: cd manual-testing/apple-mail && ./start-servers.sh"
echo "3. Setup Apple Mail: osascript manual-testing/apple-mail/setup-apple-mail.scpt"
echo "4. Test automation: osascript manual-testing/apple-mail/automated-mail-test.scpt"
echo ""
echo "🍎 Apple Mail Scripts: manual-testing/apple-mail/"
echo "📧 Using secure .fastn email addresses"
echo ""