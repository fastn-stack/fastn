...
pub fn render_pipeline(wgpu: &fastn_runtime::wgpu::boilerplate::Wgpu) -> wgpu::RenderPipeline {
    let shader = wgpu.device.create_shader_module(wgpu::include_wgsl!("rectangles.wgsl"));
...
impl RectData {
    pub fn new(_v: Vec<fastn_runtime::operation::Rectangle>, w: &fastn_runtime::wgpu::boilerplate::Wgpu) -> Self {
        use wgpu::util::DeviceExt;

        let vertices: Vec<Vertex> = vec![];
        // TODO: populate vertices

        let buffer = w.device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
