...
pub async fn matched_thread_members(
    ...
    Ok(user_joined_threads
        .into_iter()
        .map(|thread| fastn_core::user_group::UserIdentity {
...
pub async fn matched_event_members(
    ...
    Ok(user_joined_events
        .into_iter()
        .map(|event| fastn_core::user_group::UserIdentity {
...
pub async fn matched_member_permission(
    ...
    Ok(member_role_list
        ...
        .map(|permission| fastn_core::user_group::UserIdentity {
...
pub mod apis {
    ...
    pub async fn user_servers(token: &str) -> fastn_core::Result<Vec<String>> {
    ...
    pub async fn thread_members(thread_id: &str) -> fastn_core::Result<Vec<String>> {
        ...
        let thread_member_list: Vec<ThreadMembers> = fastn_core::auth::utils::get_api(
            format!(
                "{}{}{}?limit=100",
    ...
    pub async fn event_members(event_id: &str) -> fastn_core::Result<Vec<String>> {
        ...
        let event_member_list: Vec<EventMembers> = fastn_core::auth::utils::get_api(
            format!(
                "{}{}{}{}{}?limit=100",
    ...
    pub async fn member_roles(user_id: &str) -> fastn_core::Result<Vec<String>> {
        ...
        let member_roles: MemberRoles = fastn_core::auth::utils::get_api(
            format!(
                "{}{}{}{}",
