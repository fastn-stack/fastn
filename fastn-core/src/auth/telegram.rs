...
pub async fn token(req: actix_web::HttpRequest) -> fastn_core::Result<actix_web::HttpResponse> {
...
pub async fn matched_telegram_admin(
    ...
    Ok(matched_groups
        .into_iter()
        .map(|group_name| fastn_core::user_group::UserIdentity {
...
pub mod apis {
    ...
    pub async fn group_administrators(group_name: &str) -> fastn_core::Result<Vec<String>> {
    ...
    pub async fn get_member(group_name: &str, user_id: &str) -> fastn_core::Result<String> {
    ...
    pub async fn group_administrator_api(url: &str) -> fastn_core::Result<TelegramAdminResp> {
    ...
    pub async fn get_api(url: &str) -> fastn_core::Result<TelegramMemberResp> {
        let response = reqwest::Client::new()
            .get(url)
            .header(reqwest::header::ACCEPT, "application/json")
            .header(
