...
impl Sitemap {
    ...
    pub fn readers<'a>(
        &self,
        doc_path: &str,
        groups: &'a std::collections::BTreeMap<String, fastn_core::user_group::UserGroup>,
    ) -> (Vec<&'a fastn_core::user_group::UserGroup>, bool) {
        use itertools::Itertools;
    ...
    pub fn writers<'a>(
        ...
        doc_path: &str,
        groups: &'a std::collections::BTreeMap<String, fastn_core::user_group::UserGroup>,
    ) -> Vec<&'a fastn_core::user_group::UserGroup> {
        use itertools::Itertools;
