...
pub type Request = fastn_ds::http::Request;

#[allow(async_fn_in_trait)]
pub trait RequestUDType {
    async fn ud(&self, ds: &fastn_ds::DocumentStore) -> Option<fastn_core::UserData>;
    fn is_bot(&self) -> bool;
}

impl RequestUDType for Request {
    async fn ud(&self, ds: &fastn_ds::DocumentStore) -> Option<fastn_core::UserData> {
