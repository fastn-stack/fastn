...
pub use commands::{
    ...
    json_dump::json_dump, mark_resolved::mark_resolved, mark_upto_date::mark_upto_date,
    merge::merge, resolve_conflict::resolve_conflict, revert::revert, rm::rm, serve::listen,
