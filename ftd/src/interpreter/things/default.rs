...
pub fn default_bag() -> ftd::Map<ftd::interpreter::Thing> {
    ...
    std::iter::IntoIterator::into_iter([
        ...
        (
            ftd::interpreter::FTD_LINEAR_GRADIENT_COLOR_VALUE_TYPE.to_string(),
            ftd::interpreter::Thing::Record(ftd::interpreter::Record {
                name: ftd::interpreter::FTD_LINEAR_GRADIENT_COLOR_VALUE_TYPE.to_string(),
                fields: std::iter::IntoIterator::into_iter([
                    ftd::interpreter::Field {
                        name: "color".to_string(),
                        kind: ftd::interpreter::Kind::record(ftd::interpreter::FTD_COLOR)
            ...
            ftd::interpreter::Thing::OrType(ftd::interpreter::OrType {
                ...
                variants: vec![
                    ftd::interpreter::OrTypeVariant::Regular(ftd::interpreter::Field::new(
                        ftd::interpreter::FTD_LINEAR_GRADIENT_COLOR_VALUE,
                        ftd::interpreter::Kind::record(ftd::interpreter::FTD_LINEAR_GRADIENT_COLOR_VALUE_TYPE)
                            .into_kind_data(),
                        false,
                        None,
                        0,
                    ...
                    ftd::interpreter::OrTypeVariant::Regular(ftd::interpreter::Field::new(
                        ftd::interpreter::FTD_LINEAR_GRADIENT_COLOR_LENGTH,
                        ftd::interpreter::Kind::record(ftd::interpreter::FTD_LENGTH)
                            .into_kind_data(),
                        false,
                        None,
                        0,
            ...
            ftd::interpreter::Thing::Record(ftd::interpreter::Record {
                ...
                fields: std::iter::IntoIterator::into_iter([
                    ...
                    ftd::interpreter::Field {
                        ...
                        kind: ftd::interpreter::Kind::or_type(ftd::interpreter::FTD_LINEAR_GRADIENT_COLOR).into_list()
                            .into_kind_data(),
                        mutable: false,
                        value: None,
                        line_number: 0,
