use ftd::evalexpr::function::builtin::builtin_function;

use ftd::evalexpr::{context::Context, error::*, value::Value, ContextWithMutableVariables};
...
impl Operator {
    ...
    pub(crate) const fn precedence(&self) -> i32 {
        use ftd::evalexpr::operator::Operator::*;
        match self {
            RootNode => 200,
