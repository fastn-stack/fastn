...
pub struct Common {
    ...
    pub move_up: ftd::executor::Value<Option<ftd::executor::TranslateLength>>,
...
pub fn common_from_properties(
    ...
    Ok(Common {
        ...
        move_up: ftd::executor::TranslateLength::optional_translate_length(
            properties,
            arguments,
            doc,
            line_number,
        ...
        move_down: ftd::executor::TranslateLength::optional_translate_length(
            properties,
            arguments,
            doc,
            line_number,
        ...
        move_left: ftd::executor::TranslateLength::optional_translate_length(
            properties,
            arguments,
            doc,
            line_number,
        ...
        move_right: ftd::executor::TranslateLength::optional_translate_length(
            properties,
            arguments,
            doc,
            line_number,
