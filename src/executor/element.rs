...
pub struct Common {
    ...
    pub move_up: ftd::executor::Value<Option<i64>>,
    pub move_down: ftd::executor::Value<Option<i64>>,
    pub move_left: ftd::executor::Value<Option<i64>>,
    pub move_right: ftd::executor::Value<Option<i64>>,
...
pub fn common_from_properties(
    ...
    Ok(Common {
        ...
        move_up: ftd::executor::value::optional_i64(
            "move-up",
            properties,
            arguments,
            doc,
        ...
        move_down: ftd::executor::value::optional_i64(
            "move-down",
            properties,
            arguments,
            doc,
        ...
        move_left: ftd::executor::value::optional_i64(
            "move-left",
            properties,
            arguments,
            doc,
        ...
        move_right: ftd::executor::value::optional_i64(
            "move-right",
            properties,
            arguments,
            doc,
        ...
        scale: ftd::executor::value::optional_f64(
            "scale",
            properties,
            arguments,
            doc,
        ...
        scale_x: ftd::executor::value::optional_f64(
            "scale-x",
            properties,
            arguments,
            doc,
        ...
        scale_y: ftd::executor::value::optional_f64(
            "scale-y",
            properties,
            arguments,
            doc,
