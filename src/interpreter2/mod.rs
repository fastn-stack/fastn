...
pub use constants::{
    ...
    FTD_WHITESPACE_PRELINE, FTD_WHITESPACE_PREWRAP, FTD_TEXT_TRANSFORM, FTD_TEXT_TRANSFORM_NONE,
    FTD_TEXT_TRANSFORM_CAPITALIZE, FTD_TEXT_TRANSFORM_UPPERCASE, FTD_TEXT_TRANSFORM_LOWERCASE,
    FTD_TEXT_TRANSFORM_INITIAL, FTD_TEXT_TRANSFORM_INHERIT
};
pub use main2::{
